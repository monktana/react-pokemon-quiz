...
describe('Unit Test Effectiveness Calculation', () => {
  ...
  context('normal', () => {
    it('is effective against psychic', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.abra)).to.eq(TypeEffectiveness.Effective);
    });
    ...
    it('is effective against bug', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.caterpie)).to.eq(TypeEffectiveness.Effective);
    });
    ...
    it('is effective against fairy', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.clefairy)).to.eq(TypeEffectiveness.Effective);
    });

    it('is effective against ground', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.diglett)).to.eq(TypeEffectiveness.Effective);
    });

    it('is effective against dragon', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.dratini)).to.eq(TypeEffectiveness.Effective);
    });

    it('is effective against poison', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.ekans)).to.eq(TypeEffectiveness.Effective);
    });

    it('has no effect against ghost', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.gastly)).to.eq(TypeEffectiveness.NoEffect);
    });

    it('is not very effective against rock', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.geodude)).to.eq(TypeEffectiveness.NotVeryEffective);
    });

    it('is not very effective against steel', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.magnemite)).to.eq(TypeEffectiveness.NotVeryEffective);
    });

    it('is effective against fighting', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.mankey)).to.eq(TypeEffectiveness.Effective);
    });

    it('is effective against flying', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.pidgey)).to.eq(TypeEffectiveness.Effective);
    });

    it('is effective against electric', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.pikachu)).to.eq(TypeEffectiveness.Effective);
    });
    ...
    it('is effective against dark', function() {
      expect(getAttackEffectiveness(this.matchup.move, this.umbreon)).to.eq(TypeEffectiveness.Effective);
    });
  });
});