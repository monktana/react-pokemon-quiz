  ...
  return (
    <div className="flex flex-row gap-2">
      <div
        ...
        className="relative w-12 h-12 border-4 border-black rounded-full bg-gradient-to-r from-red-500 to-red-500"
      >
        <div
          className="absolute w-4 h-4 -translate-x-1/2 -translate-y-1/2 bg-white border-4 border-black rounded-full top-1/2 left-1/2"
        />
      </div>
      <Button
